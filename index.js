 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`denariicore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`denariicore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'denariicore-' + name : 'denariicore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/denariicore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external denariicore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:denariicore-lib -o denariicore-lib.js';
    }
